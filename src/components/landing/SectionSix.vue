...
<section class="section section-dark section-angled border-0 pb-0 m-0"
				style="background-size: 100%; background-position: top;" data-plugin-lazyload
				data-plugin-options="{'threshold': 500}" data-original="landing/img/build_bg.jpg">
				<div class="section-angled-layer-top section-angled-layer-increase-angle"
					style="padding: 4rem 0; background-color: #f4f4f4;"></div>
				<div class="container text-center my-5 py-5">
					<h2 class="font-weight-bold line-height-3 text-12 mt-5 mb-3 appear-animation"
						...
						data-appear-animation-duration="750">Build your web store with iMarketplace.World</h2>
					<h4 class="font-weight-bold text-9 mb-4 pb-2 appear-animation"
						data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500"
						data-appear-animation-duration="750">Start now for less than <span
							...
							data-appear-animation-duration="750">$1 dollar per day!</span></h4>
					<div class="appear-animation" data-appear-animation="fadeInUpShorter"
						data-appear-animation-delay="900" data-appear-animation-duration="750">
						<h4 class="font-weight-normal text-4 col-lg-6 px-0 offset-lg-3 fw-400 mb-5 opacity-8">iMarketplace.World enables you to create a web store without limits.</h4>
					</div>
