<template>
<section class="section section-concept section-no-border home-content section-angled section-angled-reverse pt-5 m-0 mb-5" id="section-concept">
         <div class="section-angled-layer-bottom" style="padding: 8rem 0;"></div>
            ...
            <div class="row align-items-center pt-3" >
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="font-weight-bold line-height-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750">
                        ...
                        <span class="appear-animation text-primary" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600" data-appear-animation-duration="800">
...
<style scoped>
.home-content {
    background-image: url(/assets/bg/bground.png) !important;
