        ...
        <section className="section section-funnel relative z-10 border-0 !mt-0 pt-0 m-0">
          <div className="container pb-5 mb-5">
            <h2 className="fotn-weight-extra-bold mb-1 text-center">
              ...
              >
                People Already Using {"'Blackowned.store'"} Store Design
                Technology
              </span>
            </h2>
            <p
            ...
            >
              100K+ IN ALL {"Blackowned.store.'S TECHNOLOGY'S"} VERSIONS
            </p>
            <div
            ...
            <Swiper pagination={true} modules={[Pagination]}>
              <SwiperSlide>
                <div className="w-full md:w-2/3 xl:w-2/5 mx-auto bg-purple-600 text-white rounded-xl p-4 md:p-12">
                  ...
                  <p className="mb-0">
                    {'"Working'} with IMarket Place has been an absolute
                    pleasure. Their eCommerce platform provided an intuitive and
